...
const Cabecalho =  () => {
    ...
    async function perguntaRemover(id){
        ...
        if( alerta == true){
            await api.delete(`${env.endpoint}/header/${id}`)
                ...
                <div className="box box-primary">
                    <div className="box-header with-border">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-6">
                                <Link to="/cabecalho/cadastro" className="btn btn-success pull-right" type="button"><i className="fa fa-plus"></i></Link>
                            </div>
                        </div>
                    </div>
